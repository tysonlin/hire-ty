...
description: "Trim a job application CV (cv.tex) to fit exactly one page by adjusting font size, line spacing, and content density. Use when asked to shrink, trim, fit to one page, or reduce a CV that is overflowing onto a second page."
